...
import { PayStackProps, PayStackRef, ISplitPayment } from './types';

const CLOSE_URL = 'https://standard.paystack.co/close';

type Props = PayStackProps & ISplitPayment;

const SimpleSplit: React.ForwardRefRenderFunction<React.ReactNode, Props> = (
    {
        paystackKey,
        billingEmail,
        phone,
