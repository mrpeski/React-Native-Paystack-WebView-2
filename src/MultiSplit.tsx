...
type Props = PayStackProps & ISplitPayment & IMultiSplitPayment;

const MultiSplit: React.ForwardRefRenderFunction<React.ReactNode, Props> = (
    {
        paystackKey,
        billingEmail,
        phone,
...
export default forwardRef(MultiSplit);
